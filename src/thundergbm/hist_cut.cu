...
void HistCut::get_cut_points3(SparseColumns &columns, int max_num_bins, int n_instances) {
    ...
    //std::vector<int> tmp1;
    //std::ifstream infile1("/home/xbr/hpc_code/xgboost/test_bench/real-sim_train_ptr.txt");
    //int val1;
    //while(infile1 >> val1){
    //    tmp1.push_back(val1);
    //}
    ...
    //std::ifstream infile2("/home/xbr/hpc_code/xgboost/test_bench/real-sim_train_val.txt");
    //float val2;
    //while(infile2 >> val2){
    //    tmp2.push_back(val2);
    //}
